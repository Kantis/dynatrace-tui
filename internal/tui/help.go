...
var helpSections = []helpSection{
	{"Global", []helpEntry{
		...
		{"Alt-D", "toggle detail simplified / full"},
		{"Alt-1 / Alt-2 / Alt-3", "switch view (Query / Saved / Fragments)"},
		{"Tab / Shift-Tab", "cycle focus"},
		{"?", "this help"},
		{"Esc", "cancel running query / leave detail"},
	...
	{"Results table", []helpEntry{
		{"↑ / ↓ (or k / j)", "move cursor (detail preview follows)"},
		{"Enter", "expand the detail pane fullscreen"},
		{"Tab", "focus the detail preview without expanding"},
	}},
	{"Detail viewport", []helpEntry{
		{"/", "search in content"},
		{"n / N", "next / previous match"},
		{"gg / G", "top / bottom"},
		{"q / Esc", "back to results (also collapses fullscreen)"},
	}},
